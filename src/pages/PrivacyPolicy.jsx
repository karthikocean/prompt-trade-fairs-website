      ...
      <section className="legal-content-section" style={{padding: '100px 0', background: '#fff'}}>
        <div className="container">
           <div className="legal-doc-wrap" style={{lineHeight: '1.8', color: '#444'}}>
              ...
              <h2 style={{fontSize: '1.8rem', fontWeight: '800', color: '#111', margin: '20px 0 10px', borderBottom: '2px solid #ED1C24', display: 'inline-block', paddingBottom: '10px'}}>2. Information We Collect</h2>
              ...
              <h2 style={{fontSize: '1.8rem', fontWeight: '800', color: '#111', margin: '20px 0 10px', borderBottom: '2px solid #ED1C24', display: 'inline-block', paddingBottom: '10px'}}>3. Methods of Collection</h2>
              ...
              <h2 style={{fontSize: '1.8rem', fontWeight: '800', color: '#111', margin: '20px 0 10px', borderBottom: '2px solid #ED1C24', display: 'inline-block', paddingBottom: '10px'}}>4. Purpose of Processing Information</h2>
              ...
              <h2 style={{fontSize: '1.8rem', fontWeight: '800', color: '#111', margin: '20px 0 10px', borderBottom: '2px solid #ED1C24', display: 'inline-block', paddingBottom: '10px'}}>5. Disclosure and Sharing of Information</h2>
              ...
              <h2 style={{fontSize: '1.8rem', fontWeight: '800', color: '#111', margin: '20px 0 10px', borderBottom: '2px solid #ED1C24', display: 'inline-block', paddingBottom: '10px'}}>6. Photography, Videography, and Media Consent</h2>
              ...
              <h2 style={{fontSize: '1.8rem', fontWeight: '800', color: '#111', margin: '20px 0 10px', borderBottom: '2px solid #ED1C24', display: 'inline-block', paddingBottom: '10px'}}>7. Data Security</h2>
              <p style={{marginBottom: '20px'}}>
              ...
              <h2 style={{fontSize: '1.8rem', fontWeight: '800', color: '#111', margin: '20px 0 10px', borderBottom: '2px solid #ED1C24', display: 'inline-block', paddingBottom: '10px'}}>8. Data Retention</h2>
              <p style={{marginBottom: '20px'}}>
              ...
              <h2 style={{fontSize: '1.8rem', fontWeight: '800', color: '#111', margin: '20px 0 10px', borderBottom: '2px solid #ED1C24', display: 'inline-block', paddingBottom: '10px'}}>9. Participant Rights</h2>
              ...
              <h2 style={{fontSize: '1.8rem', fontWeight: '800', color: '#111', margin: '20px 0 10px', borderBottom: '2px solid #ED1C24', display: 'inline-block', paddingBottom: '10px'}}>10. Cookies and Digital Technologies</h2>
              <p style={{marginBottom: '30px'}}>
              ...
              <h2 style={{fontSize: '1.8rem', fontWeight: '800', color: '#111', margin: '20px 0 10px', borderBottom: '2px solid #ED1C24', display: 'inline-block', paddingBottom: '10px'}}>11. Third-Party Links</h2>
              <p style={{marginBottom: '20px'}}>
              ...
              <h2 style={{fontSize: '1.8rem', fontWeight: '800', color: '#111', margin: '20px 0 10px', borderBottom: '2px solid #ED1C24', display: 'inline-block', paddingBottom: '10px'}}>12. Consent</h2>
              <p style={{marginBottom: '30px'}}>
              ...
              <h2 style={{fontSize: '1.8rem', fontWeight: '800', color: '#111', margin: '20px 0 20px', borderBottom: '2px solid #ED1C24', display: 'inline-block', paddingBottom: '10px'}}>14. Contact Information</h2>
